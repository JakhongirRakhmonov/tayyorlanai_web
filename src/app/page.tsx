...
const stats = [
  { value: "73+", label: "Foydalanuvchilar" },
  { value: "500+", label: "Materiallar qayta ishlangan" },
  { value: "3 soniya", label: "O'rtacha natija vaqti" },
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-28 pb-20 px-5 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <h1 className="animate-slide-up delay-100 text-4xl md:text-6xl font-bold mb-6 text-white leading-tight">
            AI bilan o&apos;qishni
            <br />
            <span className="text-yellow-300">osonlashtiring</span>
          </h1>
        ...
        {/* Decorative blobs */}
        <div className="absolute -bottom-20 -left-20 w-60 h-60 bg-yellow-400/20 rounded-full blur-3xl" />
      ...
      <section className="py-12 px-5 bg-gray-50">
        <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6">
          {stats.map((s, i) => (
            <div key={i} className="text-center animate-slide-up" style={{ animationDelay: `${i * 100}ms`, animationFillMode: 'both' }}>
      ...
      <section id="features" className="py-16 px-5">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map((f, i) => (
              <div key={f.title} className="group bg-white rounded-2xl p-6 border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 animate-slide-up" style={{ animationDelay: `${i * 80}ms`, animationFillMode: 'both' }}>
      ...
      <section className="py-16 px-5 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-500 text-center mb-12">3 oddiy qadam — va tayyor!</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {steps.map((s, i) => (
              <div key={i} className="text-center animate-slide-up" style={{ animationDelay: `${i * 150}ms`, animationFillMode: 'both' }}>
                ...
                {i < 2 && <div className="hidden md:block text-3xl text-gray-300 mt-4">→</div>}
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-5">
        <div className="max-w-3xl mx-auto text-center bg-gradient-to-br from-primary-600 to-accent-600 rounded-3xl p-10 md:p-16 relative overflow-hidden">
      ...
      {/* Footer */}
      <footer className="border-t bg-gray-50 py-10 px-5">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6 text-sm text-gray-400">
            <Link href="/app" className="hover:text-primary-600 transition">Platforma</Link>
            <a href="#features" className="hover:text-primary-600 transition">Imkoniyatlar</a>
          </div>
          <p className="text-sm text-gray-400">© 2026 TayyorlanAI ❤️</p>
        </div>
      </footer>
    </div>
  );
